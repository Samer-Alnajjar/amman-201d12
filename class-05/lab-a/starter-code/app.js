...
function multiply(a, b) { //eslint-disable-line
    ...
    var returnArray = [
        total,
        "The product of " + a + " and " + b + " is " + total + "."
        // "The product of 5 and 9 is 45."
    ];
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
    ...
    var totalMul = multiply(multiply(a, b)[0], c)[0];
    var thirdElem = a + " and " + b + " and " + c + " sum to " + totalSum + ".";
    var fourthElem = "The product of " + a + " and " + b + " and " + c + " is " + totalMul + ".";
    var array = [totalSum, totalMul, thirdElem, fourthElem];
    return array;
}
